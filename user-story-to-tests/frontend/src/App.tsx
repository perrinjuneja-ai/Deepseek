...
function App() {
  ...
  const handleStorySelected = (story: JiraUserStory) => {
    // Auto-fill form with Jira story details
    setFormData(prev => ({
      ...prev,
      storyTitle: story.title || prev.storyTitle,
      description: story.description || prev.description,
      acceptanceCriteria: story.acceptanceCriteria || prev.acceptanceCriteria // Use Jira acceptance criteria if available
    }))
  }
    ...
    <div>
      ...
      <div className="container">
        ...
        <JiraConfig 
          ...
          onConfigChange={(config) => console.log('Jira config updated:', config)}
        />
